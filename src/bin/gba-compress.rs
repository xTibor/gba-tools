...
use gba_compression::bios::{RleCompressor, Lz77Compressor, Diff8Filter, Diff16Filter, HuffmanCompressor};
use gba_compression::game_specific::{Wl4RleCompressor, Wl4Rle8Compressor, Wl4Rle16Compressor};
